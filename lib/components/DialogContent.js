 ...
 * class based on this.
 */
var DialogContent = exports.DialogContent = /*#__PURE__*/function (_React$PureComponent) {
  function DialogContent(props, state) {
    var _this;
    (0, _classCallCheck2["default"])(this, DialogContent);
    _this = _callSuper(this, DialogContent, [props]);
  ...
  return (0, _createClass2["default"])(DialogContent, [{
    key: "t",
